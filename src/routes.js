...
routes.get('/node/reservations/:id', ClassReservation.getReservastionByTeacherId);
...
routes.put('/node/reservations/class/students/:id', ClassReservation.addStudents);

// Class admin
routes.post('/node/admin/class/reservation', ClassReservation.adminReservationStore);
routes.get('/node/admin/reservations/:id', ClassReservation.getReservastionByAdminId);
routes.put('/node/admin/reservations/class/:id', ClassReservation.addStudentsAdmin);
routes.delete('/node/admin/reservations/class/:id', ClassReservation.deleteAdmin);
...
routes.put('/node/reservations/student/disapprove/:id', ReserveController.disapprove);
